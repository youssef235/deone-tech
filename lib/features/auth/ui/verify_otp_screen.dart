        ...
        child: Container(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Lottie.asset(AppAssets.notification , height: MediaQuery.of(context).size.height/2),
                  ...
                  child:TextButton(
                    onPressed: () async {
                      if (otpCode.length<6) {
                        ...
                        if(result==LoginStatus.active) {
                          Navigator.pushNamedAndRemoveUntil(context, Routes.initRoute, (route) => false);
                        }
                        else if(result==LoginStatus.waiting){
                          Navigator.pushNamedAndRemoveUntil(context, Routes.waiting, (route) => false);
